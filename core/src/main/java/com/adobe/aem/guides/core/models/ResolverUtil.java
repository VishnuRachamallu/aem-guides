...
public final class ResolverUtil {
	...
	public static final String GEEKS_SERVICE_USER = "sumanth";
    /**
     * @param  resourceResolverFactory factory
     * @return new resource resolver for Sony service user 
     * @throws LoginException if problems
     */
    public static ResourceResolver newResolver1( ResourceResolverFactory resourceResolverFactory ) throws LoginException {
